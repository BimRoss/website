/**
 * Social brand marks — `currentColor`, 24×24 viewBox. Filled paths; email uses stroke (outline envelope).
 * Geometry from standard brand / Simple Icons–style silhouettes for crisp rendering at small sizes.
 */

function BrandSvg({ className, strokeWidth: _s, children, ...rest }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
/** Phone handset — stroke icon to match Email outline style. */
export function PhoneIcon({ className, strokeWidth = 1.9, ...rest }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
